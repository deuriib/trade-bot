...
- 🔝 **AUTO2 动态选币**: 基于 24h 回测结果自动选择最佳交易币种 - AI 自动挑选最优资产。
...
| Agent | 角色 | 职责 |
|-------|------|------|
| **🔝 SymbolSelectorAgent** | AUTO2 Selector | 基于回测的动态币种选择，从 AI500 Top 5 自动筛选 Top 2 最佳交易币种 |
...
- ✅ **AUTO2 动态选币系统**: 新增 `SymbolSelectorAgent` 自动选择最佳交易币种。
